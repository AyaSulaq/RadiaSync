...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run FedMed-GAN on a specified MRI image.")
    parser.add_argument("image_path", type=str, help="Path to the input MRI image.")
    parser.add_argument("--output_dir", type=str, default="/home/user/FedMed-GAN-main/work_dir/mri_to_ct_output/", help="Directory to save output images.")
    # parser.add_argument("--output_dir", type=str, default="/home/user/FedMed-GAN-main/work_dir/mri_to_ct_output/", help="Directory to save output images.")
    ...
    generator_path = '/home/user/FedMed-GAN-main/work_dir/federated/synthrad/Without Self-Attention/checkpoint/g_from_a_to_b/best_model_mri_ct_13.1696.pth'
    ...
    input_image_path = os.path.join(args.output_dir, f"{identifier}-input-MRI.jpg")
    ...
    plt.axis('off')
    output_image_path = os.path.join(args.output_dir, f"{identifier}-output-CT.jpg")
