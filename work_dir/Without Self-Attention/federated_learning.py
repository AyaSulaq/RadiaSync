...
#                wandb.log({"MAE": mae, "PSNR": psnr, "SSIM": ssim, "FID": fid if self.para_dict['fid'] else None, "Phase": "Client Training", "Direction": "A to B"})
 ...
 #               wandb.log({"MAE": mae, "PSNR": psnr_2, "SSIM": ssim, "FID": fid if self.para_dict['fid'] else None, "Phase": "Client Training", "Direction": "B to A"})
